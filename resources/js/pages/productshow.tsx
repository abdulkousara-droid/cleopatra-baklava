...
export default function ProductShow({ product, relatedProducts = [] }) {
    ...
    const currentProduct = product || {
        ...
        additionalImages: [
            ...
            'https://lh3.googleusercontent.com/aida-public/AB6AXuDp6aWXq6qj-mt7--BnVipKoO6qBNV9tFXu5dMMwvrTnx9U-F5F1h6DV-NN5_RN-iIQnVTAkVwuIt-6YUR46pJm6wey4I-Gl75z2nHWxggfXpBvRJMGRvthxHmQ-AWU_eeYKMYTQBVQYDWpatj_tCKrNT0_H1YfxuJTVIS5As6ieMMmgHSf-BS4xwj8j9sZz5ycSktgL4zfAWUgJX6AbRvQ6jbajDBF7kfPMNpgp0jDOa31_4o01DYGEPhbVn8Jf6qHqAnhgf2ZHs_N',
        ],
    };

    return (
        <div className="text-on-surface selection:bg-primary-fixed selection:text-on-primary-fixed min-h-screen bg-background font-sans">
            <main className="py-12">
                {/* Product Hero Section */}
                <section className="max-w-container-max md:px-margin-desktop mx-auto mb-24 px-6">
                    <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-12">
                        ...
                        <div className="space-y-6 lg:col-span-7">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                {currentProduct.additionalImages?.map(
                                    (imgUrl, index) => (
                                        <div
                                            key={index}
                                            onClick={() =>
                        ...
                        <div className="lg:sticky lg:top-12 lg:col-span-5">
                            ...
                            <h1 className="text-on-surface mb-2 font-headline-md text-4xl md:text-5xl">
                                {currentProduct.title}
                            </h1>
                            ...
                            <div className="mb-10 space-y-8">
                                <div>
                                    <h3 className="text-label-md text-on-surface mb-3 font-label-md uppercase">
                                        The Craft
                                    </h3>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {currentProduct.tags?.map((tag, i) => (
                                            <span
                                                key={i}
                                                className="text-on-primary-container rounded-full bg-primary/10 px-3 py-1 font-label-md text-[12px]"
                                            >
                                                {tag}
                                            </span>
                                        ))}
                                ...
                                <div className="border-outline-variant/30 bg-surface-container-low rounded-xl border p-4">
                                    <div className="mb-2 flex items-center gap-2">
                                        ...
                                        />
                                        <span className="text-on-surface font-label-md text-[12px] uppercase">
                                            Allergen Information
                                        </span>
                                    </div>
                                    <p className="text-on-surface-variant font-sans text-[12px]">
                                        Contains: Nuts (Pistachios), Gluten
                                        (Wheat), Dairy (Milk). May contain
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <div className="border-outline-variant flex h-14 items-center overflow-hidden rounded-lg border bg-white">
                                        ...
                                        <span className="w-12 text-center font-body-md font-semibold select-none">
                                            {quantity}
                                        </span>
                                        <button
                                            className="hover:bg-surface-container flex h-full items-center justify-center px-4 transition-colors"
                                    ...
                                    <button className="text-on-primary text-label-md h-14 flex-1 rounded-lg bg-primary font-label-md tracking-widest uppercase shadow-md transition-all hover:brightness-110 active:scale-[0.98]">
                                        Buy Now
                                    </button>
                                </div>
                                <button className="text-label-md h-14 w-full rounded-lg border-2 border-primary bg-transparent font-label-md font-semibold tracking-widest text-primary uppercase transition-all hover:bg-primary/5">
                                    Add to Cart
                                </button>
                            </div>
                ...
                {/* Geometric Separator */}
                <div className="max-w-container-max px-margin-desktop mx-auto mb-24 flex items-center gap-4 opacity-30">
                ...
                <section className="max-w-container-max md:px-margin-desktop mx-auto mb-32 px-6">
                    <h2 className="mb-16 text-center font-headline-md text-3xl">
                        Related Delights
                    </h2>
                        ...
                        {relatedProducts.length > 0 ? (
                            relatedProducts.map((item) => (
                                ...
                                >
                                    ...
                                    <h3 className="mb-1 font-body-lg font-bold transition-colors group-hover:text-primary">
                                        {item.title}
                                    </h3>
                            ...
                            <p className="text-on-surface-variant col-span-full text-center opacity-60">
                                Loading exceptional pairings...
                            </p>
                        )}
                    </div>
                </section>
                ...
                <section className="max-w-container-max md:px-margin-desktop mx-auto mb-32 px-6">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        <div className="bg-surface-container border-outline-variant/20 flex flex-col items-center justify-center rounded-2xl border p-8 text-center shadow-sm">
                            <h3 className="mb-2 font-headline-sm text-xl">
                                Customer Rating
                            </h3>
                            <div className="mb-2 text-[64px] leading-none font-bold text-primary">
                                4.8
                            </div>
                            ...
                            <p className="text-on-surface-variant font-body-md text-sm">
                                Based on 128 verified purchases from our
                                Barcelona boutique and online shop.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:col-span-2">
                            <div className="border-outline-variant/20 rounded-xl border bg-white p-6 shadow-sm">
                                <div className="mb-4 flex justify-between">
                                    <span className="text-on-surface font-label-md text-sm">
                                        Marta S.
                                    </span>
                                ...
                                <p className="text-on-surface-variant font-body-md text-sm italic">
                                    "The texture is unlike any baklava I've had.
                                    The honey is subtle, letting the quality of
                                    the pistachios shine through."
                                </p>
                            </div>
                            <div className="border-outline-variant/20 rounded-xl border bg-white p-6 shadow-sm">
                                <div className="mb-4 flex justify-between">
                                ...
                                <p className="text-on-surface-variant font-body-md text-sm italic">
                                    "Perfect crunch. It feels very premium and
                                    makes for an incredible gift. The packaging
                                    is as beautiful as the taste."
                                </p>
                            </div>
